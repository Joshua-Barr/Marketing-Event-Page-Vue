    ...
    <div class="footer-max-width max-content-container">
      ...
      <div class="footer-bottom-container">
        <div class="footer-left-side">
          <img alt="image" src="/logo-white-1200w.png" class="footer-image" />
      ...
      <div class="footer-copyright">
        <span class="footer-text23">
          <span>
            <span>
              © All rights reserved
              <span v-html="rawqw84"></span>
            </span>
            <span><span v-html="raw7s04"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              Powered by
              <span v-html="rawo54s"></span>
            </span>
            <span><span v-html="rawxke1"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              . Image source:
              <span v-html="raw6906"></span>
            </span>
            <span><span v-html="raw21ub"></span></span>
          </span>
          <a
