          ...
          <div class="home-content-container">
            <h1 class="home-text">
              <span class="Heading1">
                ...
                <span v-html="rawwjpv"></span>
              </span>
              <br />
            </h1>
            <h1 class="home-text03">Cyber Security</h1>
            <h1 class="home-text04 Heading1">
              <span class="Heading1">partner</span>
              <span class="Heading1">;</span>
            </h1>
            <span class="home-text07">
              GET GUIDANCE TO HELP NAVIGATE THE CYBER SECURITY GOVERNANCE AND
      ...
      <div class="home-sponsors section-container">
        <div class="home-max-width1 max-content-container">
          ...
          <div class="home-container1">
            <img alt="image" src="/group%207-1200w.png" class="home-image" />
            <img alt="image" src="/group%208-1200w.png" class="home-image1" />
            <img alt="image" src="/group%209-1200w.png" class="home-image2" />
            <img alt="image" src="/group%2010-1200w.png" class="home-image3" />
            <img alt="image" src="/group%2011-1200w.png" class="home-image4" />
            <img alt="image" src="/group%2012-1200w.png" class="home-image5" />
          </div>
        </div>
      </div>
        ...
        <div class="home-container2 max-content-container">
          <div class="home-heading-container1">
            <span class="home-text15">
              We value high value reported security services and implementation
            </span>
            <h1 class="home-text16 Heading2">OUR CoRE Cyber ServicES</h1>
          </div>
      ...
      <div class="home-location">
        ...
        <div class="home-content-container1 section-container">
          <div class="home-container3">
            <span class="home-text17">berlin, germany</span>
            <span class="home-text18">7-8 MARCH 2023</span>
            <div class="home-container4">
              <span class="home-text19"><span>— mob-x</span></span>
              <span class="home-text21"><span>conference</span></span>
              <span class="home-text23"><span>center</span></span>
            </div>
            <div class="home-container5">
              <span class="home-text25">beautiful, vibrant berlin</span>
      ...
      <div class="home-agenda section-container">
        <div class="home-max-width3 max-content-container">
          <div class="home-heading-container2">
            <h1 class="home-text30 Heading2"><span>key events agenda</span></h1>
            <span class="home-text32">more announcements are coming soon</span>
          </div>
          <div class="home-events-container">
            <div class="home-column">
              <div class="home-column-header">
                <span class="home-text33"><span>tuesday - 7.03</span></span>
  ...
  data-driven results"
            ...
            <div class="home-column1">
              <div class="home-column-header1">
                <span class="home-text35"><span>wednesday - 8.03</span></span>
      ...
      <div class="home-workshops">
        <div class="home-content-container2">
          <div class="home-container6">
            <h1 class="home-text37 Heading2">
              <span>
                register for
                <span v-html="raw35q6"></span>
              </span>
              <br />
              <span class="home-text40">super insightful</span>
              <span><span v-html="raw9mf5"></span></span>
              <br />
              <span>
                workshops for
                <span v-html="rawhe4f"></span>
              </span>
              <br />
              <span>your team</span>
            </h1>
      ...
      <div class="home-previous-events section-container">
        <div class="home-max-width4 max-content-container">
          <div class="home-heading-container3">
            <h1 class="home-text48 Heading2"><span>previous events</span></h1>
